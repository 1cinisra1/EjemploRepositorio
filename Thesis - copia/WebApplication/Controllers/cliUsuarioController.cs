...
namespace WebApplication.Controllers
{
    public class cliUsuarioController : Controller
    {
        ...
        [ChildActionOnly]
        public ActionResult childListar()
        {
            return PartialView(db.cli_empresa.ToList());
        }
        ...
        public ActionResult ListaUsr(int? id, int? id2)
        {
            if (id == null)
            {
                return new HttpStatusCodeResult(HttpStatusCode.BadRequest);
            }
            cli_usuario user = db.cli_usuario.Find(id, id2);
            if (user == null)
            {
                return HttpNotFound();
            }
